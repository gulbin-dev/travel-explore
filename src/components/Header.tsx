...
export default function Header() {
  return (
    <>
      <header className="fixed top-0 left-0 z-10 h-full max-h-12.5 w-full px-3 py-1.25">
        ...
        <div className="flex w-full max-w-180 items-center justify-between place-self-center">
          ...
          />
          <button className="desktop:hidden flex max-h-6 flex-col justify-center gap-1.5">
            <MenuSpan />
